...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     version-control
     (elfeed :variables
             rmh-elfeed-org-files (list "~/Dropbox/org/feeds/elfeeds.org")
